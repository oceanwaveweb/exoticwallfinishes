        ...
        <main>
            ...
            <section className="atelier-hero reveals fade-in-up">
                <div className="container">
                    ...
                    <h1 className="display-title">EXOTIC PLASTER STUDIO</h1>
                </div>
            </section>
                ...
                <div className="container layout-offset">
                    ...
                    <div className="image-block reveals zoom-in delay-1">
                        <div className="aspect-portrait">
                            <img src="/images/artisan_trowel_1772909203882.jpg" alt="Master Artisan Gian Carlo Sagasti Applying Lime Plaster with Burnishing Trowel" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="vision-container">
                    ...
                    <div className="vision-image-wrap">
                        <img
                            ...
                            alt="Polished Italian Marmorino Lime Plaster Feature Wall"
                            className="vision-main-img"
                            ref={mainImgRef}
                        />
                        <img
                            src="/images/Exhibition 3rd card.jpg"
                            alt="Artisan Hand Applying Custom Metallic Plaster Finish"
                ...
                <div className="container layout-offset">
                    ...
                    <div className="image-block">
                        <div className="aspect-square">
                            <img src="/images/marmorino_tools.png" alt="Authentic Italian Marmorino Tools and Venetian Plaster Supplies" className="static-color" />
                        </div>
                    </div>
                </div>
            </section>
