        ...
        <main>
            ...
            <section className="atelier-hero reveals fade-in-up">
                <div className="container">
                    ...
                    <h1 className="display-title">THE ATELIER</h1>
                </div>
            </section>
                ...
                <div className="container layout-offset">
                    ...
                    <div className="image-block reveals zoom-in delay-1">
                        <div className="aspect-portrait">
                            <img src="/images/artisan_trowel_1772909203882.jpg" alt="Master Artisan Gian Carlo Sagasti Hand Applying Venetian Plaster with Burnishing Trowel" />
                        </div>
                    </div>
                </div>
            </section>
