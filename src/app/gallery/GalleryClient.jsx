                        ...
                        <div ref={headingRef} className="exhibition-title-area" style={{ position: 'relative', top: 'auto', width: '100%', paddingTop: '8rem', paddingBottom: '10rem' }}>
                            <div className="exhibition-heading">
                                ...
                                <h1 className="exhibition-main-title">
                                    <span className="exhibit-word" style={{ display: 'inline-block' }}>EXOTIC WORKS</span>{' '}
                                    <br className="mobile-br" />
                                    <span className="exhibit-word" style={{ display: 'inline-block' }}>& FINISHES GALLERY</span>
                                </h1>
                                ...
                                {EXHIBITION_DATA.map((item) => (
                                    ...
                                    >
                                        {item.isVideo ? (
                                            ...
                                            <img src={item.img} alt={`${item.title} - ${item.subtitle} Venetian Plaster Finish`} />
                                        )}
                                ...
                                <div className="modal-grid">
                                    <div className="modal-image-area">
                                        {selectedItem.isVideo ? (
                                            ...
                                            <img src={selectedItem.img} alt={`${selectedItem.title} - ${selectedItem.subtitle}`} />
                                        )}
                                    </div>
                    ...
                    <div className="container immersive-container">
                        ...
                        <div className="immersive-overlap-grid">
                            <div className="overlap-image reveals fade-in-up delay-1">
                                <img src="/images/venetian_plaster_wall.jpg" alt="Raw Venetian Plaster Wall Finish" className="static-color" />
                            </div>
                            ...
                            <div className="overlap-image-trowel reveals fade-in-up delay-1">
                                <img src="/images/artisan_trowel_cinematic.jpg" alt="Artisan Plaster Trowel Burnishing Surface" className="static-color" />
                            </div>
                            ...
                            <div className="overlap-image-third reveals fade-in-up delay-2">
                                <img src="/images/Exhibition 3rd card.jpg" alt="Hand Applied Venetian Plaster Finish Exhibition" className="static-color" />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="broken-grid-container">
                        ...
                        <div className="broken-grid-image reveals fade-in-up delay-1">
                            <div className="gold-glow-monolith portrait-monolith">
                                <img src="/images/generated_marmorino_gold.png" alt="Brutalist Marmorino Gold Vein Texture Surface" className="static-color" />
                            </div>
                        </div>
