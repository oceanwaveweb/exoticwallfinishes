            ...
            <div className="container footer-grid">
                <div className="f-col">
                    <div className="logo-pair" style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                        <img src="/images/Footer_WFD.png" alt="Exotic Wall Finishes and Design Logo" className="brand-img-footer" />
                        <a href="https://exoticluxuryline.com/" target="_blank" rel="noopener noreferrer" style={{ display: 'block' }}>
                            <img src="/images/Exotic Luxury Line Brand Logo.png" alt="Exotic Luxury Line Master Artisan Brand Logo" className="brand-img-footer" />
                        </a>
                    </div>
                </div>
                <div className="f-col right">
                    ...
                    <div className="f-socials" style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', justifyContent: 'flex-end' }}>
                        ...
                        <a href="https://www.mapquest.com/us/florida/venetian-plaster-exotic-wall-finishes-and-design-379443250" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-light)', opacity: 0.6, transition: 'opacity 0.3s' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1.5rem', marginTop: '0.5rem', justifyContent: 'flex-end' }}>
                        <Link href="/journal" style={{ color: 'var(--accent-gold)', fontSize: '0.75rem', textDecoration: 'none', letterSpacing: '1px' }}>ARCHITECTURAL JOURNAL</Link>
                        <Link href="/accessibility" style={{ color: 'var(--text-muted)', fontSize: '0.75rem', textDecoration: 'none', letterSpacing: '1px' }}>ACCESSIBILITY</Link>
                    </div>
                </div>
