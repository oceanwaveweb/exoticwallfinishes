        ...
        <section className="atelier" id="atelier">
            <div className="container layout-offset">
                <div className="text-block reveals slide-in-left">
                    ...
                    <p className="bio-details">
                        The goal is to leave your walls looking sexy. We are top experts in a number of decorative wall finishes including Marmorino, Venetian Plaster, Faux finishes, Lime Paint and Lime Washes from Matte to texture finishes all the way to shiny finishes and more.
                    </p>
